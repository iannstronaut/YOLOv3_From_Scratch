...
def check_class_accuracy(model, loader, threshold):
    ...
    print(
        f"[Class accuracy: {(correct_class/(tot_class_preds+1e-16))*100:.2f}%] [No obj accuracy: {(correct_noobj/(tot_noobj+1e-16))*100:.2f}%] [Obj accuracy: {(correct_obj/(tot_obj+1e-16))*100:.2f}%]"
    )
    model.train()
